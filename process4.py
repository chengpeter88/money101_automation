...
# 依照提及次數排序
sorted_indices = sorted(range(len(mention_counts)), key=lambda i: mention_counts[i], reverse=True)
...
# 4. 生成合作夥伴詞雲圖 (前5名)
top_partners = sorted(analysis_results['partner_article_counts'].items(), 
